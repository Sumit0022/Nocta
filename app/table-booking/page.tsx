...
import { Crown, Users, ArrowRight, UserPlus, X } from "lucide-react";
...
export default function TableBookingPage() {
  ...
  const handleTableSelect = (table: any) => {
    ...
    // Captain ke alawa baaki pax ke liye empty slots banao
  ...
  const proceedToPayment = () => {
    if (selectedTable) {
      // Agar table select ki hai toh sub-ordinates check karo
      ...
      // LocalStorage mein save kar diya taaki payment page padh sake
